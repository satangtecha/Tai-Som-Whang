...
# Team Tai-Som-Wang — Edge AI Workshop Day 1
...
- **ชื่อบอร์ด:** Uno Q t1
- **สมาชิก + บทบาท (3H):**
  - 🛠️ **Hacker** (เทคนิค: ต่อบอร์ด/เก็บ data/train/deploy): ปรานต์
  - 🎨 **Hipster** (ผู้ใช้: output ที่คนเข้าใจ/รูปแบบใช้งาน): ลีโอ
  - 📣 **Hustler** (คุณค่า: ปัญหา/ผู้ใช้/เล่าเดโม่): สตางค์
